...
const OrderScreen = () => {
    ...
    return (
        <SafeAreaView style={{ marginTop: 50 }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', height: 80, backgroundColor: "#fc8019", padding: 10 }}>
                <View style={{ marginLeft: 10 }}>
                    <Text style={{ fontSize: 17, fontWeight: "600", color: "white" }}>Delivery in 20 mins</Text>
                    <Text style={{ fontSize: 17, fontWeight: "600", color: "white", marginTop: 4 }}>Order placed at {time} </Text>
                </View>
