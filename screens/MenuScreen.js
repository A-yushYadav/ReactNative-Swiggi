  ...
  return (
    <>
        ...
        >
          ...
          <View style={{ backgroundColor: "white", height: 210, marginHorizontal: 20, marginVertical: 5, padding: 10, borderRadius: 15 }}>
            ...
            <View style={{ flexDirection: "row", alignItems: "center", marginTop: 7 }}>
              ...
              <Text style={{ marginLeft: 3, fontSize: 17, fontWeight: "400" }}>{route.params.time}mins</Text>
            </View>
            ...
            <View style={{ flexDirection: "row", alignItems: "center", marginTop: 10 }}>
              ...
              <Text style={{ fontSize: 16, color: "gray", marginLeft: 7 }}>0-3 Kms | </Text>
              <Text style={{ fontSize: 16, color: "gray", marginLeft: 7 }}>35 Dilivery fee will apply </Text>
            </View>
          </View>
        </View>
      ...
      <Modal isVisible={modalVisible} onBackdropPress={toggleModal}>
        <View style={{ width: 250, height: 190, backgroundColor: "black", position: "absolute", bottom: 35, right: 10, borderRadius: 7 }}>
          {menu.map((item, i) => (
            <View  key={i} style={{ padding: 10, flexDirection: "row", alignItems: "center", justifyContent: "space-between" }}>
      ...
      {total === 0 ? null : (
        <Pressable style={{ backgroundColor: "#00A877", width: "90%", padding: 13, marginLeft: "auto", marginRight: "auto", marginBottom: 30, position: "absolute", left: 20, bottom: 10, borderRadius: 8 }}>
          <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", }}>
            <View>
